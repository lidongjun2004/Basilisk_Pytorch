import torch
import ReactionWheelPower
# 创建功率计算模块
rw_power = ReactionWheelPower.ReactionWheelPower(
    basePowerNeed=5.0,       # 5W基础功率
    elecToMechEfficiency=0.8,      # 80%电到机械效率
    mechToElecEfficiency=0.6       # 60%机械到电效率
)
...
powers = rw_power.forward(omegas, u_currents)
